        ...
        <>
            ...
            <div className={"md:flex md:items-center md:justify-around md:max-w-5xl md:mx-auto md:h-[90vh]"}>
                ...
                <form
                    ...
                    <hr/>
                    <button type={"button"} className={"bg-[#42b72a] text-white text-xl font-semibold mx-auto w-[210px] rounded-lg py-3 mt-2 active:scale-95 create-account-btn"} onClick={displaySign}>Create New Account
                    </button>
                </form>
            </div>
            <SignUp passwordHideShow={passwordHideShow} signUpDisplay={signUpDisplay} setSignUpDisplay={setSignUpDisplay}/>
        </>
    )
}
