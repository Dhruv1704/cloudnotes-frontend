        ...
        <>
            ...
            <div className={"notes-basis md:pt-5 mx-auto md:mr-0 md:ml-auto"}>
                <div className={"mx-auto px-4 md:px-8 pb-2"}>
                    ...
                    <div className={"grid grid-cols-[repeat(auto-fill,348px)] gap-y-10 gap-x-4 justify-around mb-10 mt-6"}>
                    ...
                    <AddButton setColor={setColor} setDisplayAddNote={setDisplayAddNote}/>
                    <AddNote color={color} displayAddNote={displayAddNote} setDisplayAddNote={setDisplayAddNote}/>
                </div>
            </div>
        </>
    )
