    ...
    const getNotes = async () => {
        ...
        const response = await fetch(`${process.env.REACT_APP_HOST}/api/note/fetchNotes`, {
            ...
            headers: {
                ...
                'web-token': cookies['web-token']   // is only present for current tab and survives refresh. Will not be accessible in other tabs. Is deleted after the tab or browser is closed.
            },
        });
